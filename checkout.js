...
const calculateProductPrice = (btn) =>{
    const productInfoDiv = btn.closest(".product-info");
...
const calculateCartPrice = () =>{
    ...
    //getting shippingFreePrice from localStorage???
    const shippingPrice = parseFloat(subtotal > 0 && subtotal < shippingFreePrice ? localStorage.getItem("shippingPrice") : 0);
